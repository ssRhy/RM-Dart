...
static void usb_send_outputPC(uint8_t t)
{
    ...
    char_to_uint(OutputPCData.packets[0].name, "Leg0_L0");
    char_to_uint(OutputPCData.packets[1].name, "Leg1_L0");
    char_to_uint(OutputPCData.packets[2].name, "rod_L0");
    char_to_uint(OutputPCData.packets[3].name, "rod_L1");
    ...
    // char_to_uint(OutputPCData.packets[18].name, "F");
    char_to_uint(OutputPCData.packets[19].name, "pid0_out");
    char_to_uint(OutputPCData.packets[20].name, "pid1_out");
