...
void GetK(float l, float k[2][6])
{
    ...
    float t2 = l * l;
    float t3 = l * l * l;
    k[0][0] = -32.3169f * t3 + 126.0725f * t2 - 119.4719f * t1 + 3.7863f;
    k[0][1] = 24.2550f * t3 - 18.4759f * t2 - 5.2668f * t1 + 0.3189f;
    k[0][2] = -23.4949f * t3 + 29.4788f * t2 - 13.6978f * t1 + 1.0790f;
    k[0][3] = -38.5633f * t3 + 49.0515f * t2 - 23.5100f * t1 + 1.7838f;
    k[0][4] = 112.4367f * t3 - 95.7440f * t2 + 16.9660f * t1 + 5.9165f;
    k[0][5] = 24.5417f * t3 - 22.3251f * t2 + 5.1371f * t1 + 0.9994f;
    k[1][0] = 1003.2426f * t3 - 1010.3246f * t2 + 311.7347f * t1 + 1.7631f;
    k[1][1] = 59.4430f * t3 - 75.1720f * t2 + 32.2878f * t1 - 0.8031f;
    k[1][2] = 65.6946f * t3 - 51.3210f * t2 + 5.4328f * t1 + 4.4054f;
    k[1][3] = 114.0969f * t3 - 90.6934f * t2 + 10.8841f * t1 + 7.3873f;
    k[1][4] = 250.8305f * t3 - 341.4297f * t2 + 173.1749f * t1 - 17.1538f;
    k[1][5] = 30.0864f * t3 - 48.7321f * t2 + 28.6081f * t1 - 3.6986f;
}
