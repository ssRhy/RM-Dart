...
void GetK(float l, float k[2][6])
{
    ...
    float t2 = l * l;
    float t3 = l * l * l;
    k[0][0] = -226.5937f * t3 + 274.2895f * t2 - 161.8620f * t1 - 3.5275f;
    k[0][1] = 3.5196f * t3 - 2.8105f * t2 - 14.9380f * t1 + 0.0590f;
    k[0][2] = -17.9327f * t3 + 17.6587f * t2 - 5.9942f * t1 - 6.3379f;
    k[0][3] = -7.8949f * t3 + 9.5063f * t2 - 6.4602f * t1 - 6.4502f;
    k[0][4] = -177.9197f * t3 + 198.9368f * t2 - 85.8639f * t1 + 18.3058f;
    k[0][5] = -28.7064f * t3 + 32.8042f * t2 - 14.6764f * t1 + 3.6565f;
    k[1][0] = 48.1399f * t3 - 46.5617f * t2 + 15.0616f * t1 + 2.2192f;
    k[1][1] = 3.8107f * t3 - 3.9966f * t2 + 1.2686f * t1 + 0.0991f;
    k[1][2] = -26.3849f * t3 + 29.3503f * t2 - 12.3605f * t1 + 2.2516f;
    k[1][3] = -25.2802f * t3 + 27.7872f * t2 - 11.5728f * t1 + 2.0762f;
    k[1][4] = 62.3822f * t3 - 62.7210f * t2 + 22.3536f * t1 + 15.0178f;
    k[1][5] = 12.4830f * t3 - 12.8245f * t2 + 4.7707f * t1 + 2.2613f;
}
