...
#define KD_GIMBAL_YAW_ANGLE (0.3f)
...
//PITCH ANGLE
#define KP_GIMBAL_PITCH_ANGLE (250000.0f)
#define KI_GIMBAL_PITCH_ANGLE (200.0f)
#define KD_GIMBAL_PITCH_ANGLE (5000.0f)
#define MAX_IOUT_GIMBAL_PITCH_ANGLE (1000.0f)
#define MAX_OUT_GIMBAL_PITCH_ANGLE (10000.0f)
//VELOCITY:角速度
#define KP_GIMBAL_PITCH_VELOCITY (1.0f)
#define KI_GIMBAL_PITCH_VELOCITY (0.0f)
#define KD_GIMBAL_PITCH_VELOCITY (0.0f)
#define MAX_IOUT_GIMBAL_PITCH_VELOCITY (100.0f)
