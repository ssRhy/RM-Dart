...
#define DART_FEED_SPEED_PID_MAX_OUT (2000.0f)
#define DART_FEED_SPEED_PID_MAX_IOUT (200.0f)

#define DART_FEED_ANGEL_PID_KP (300.0f)
#define DART_FEED_ANGEL_PID_KI (0.0f)
#define DART_FEED_ANGEL_PID_KD (5.0f)
#define DART_FEED_ANGEL_PID_MAX_OUT (2000.0f)
#define DART_FEED_ANGEL_PID_MAX_IOUT (200.0f)
//传送电机PID
...
#define DART_SHOOT_SPEED_PID_KP 300.0f
#define DART_SHOOT_SPEED_PID_KI 0.0f
#define DART_SHOOT_SPEED_PID_KD 5.0f
#define DART_SHOOT_SPEED_PID_MAX_OUT 2000.0f
#define DART_SHOOT_SPEED_PID_MAX_IOUT 200.0f

#define DART_SHOOT_ANGEL_PID_KP 300.0f
#define DART_SHOOT_ANGEL_PID_KI 0.0f
#define DART_SHOOT_ANGEL_PID_KD 5.0f
#define DART_SHOOT_ANGEL_PID_MAX_OUT 2000.0f
#define DART_SHOOT_ANGEL_PID_MAX_IOUT 200.0f
